// micro:bit for nakopad v1.0  2025/12/31
...
input.onLogoEvent(TouchButtonEvent.Pressed, function () {
    serial.writeString("EVENT:LOGO_PRESSED\n")
    basic.pause(20) // 送信待ち
})
// 2. 離した (Released)
input.onLogoEvent(TouchButtonEvent.Released, function () {
    serial.writeString("EVENT:LOGO_RELEASED\n")
    basic.pause(20) // 送信待ち
})
// 3. 長押し (LongPressed)
input.onLogoEvent(TouchButtonEvent.LongPressed, function () {
    serial.writeString("EVENT:LOGO_LONG\n")
    basic.pause(20) // 送信待ち
})

// --- ボタンイベント ---
input.onButtonPressed(Button.AB, function () {
    serial.writeString("EVENT:AB\n")
    basic.pause(20)
})
input.onButtonPressed(Button.A, function () {
    serial.writeLine("EVENT:A")
    basic.pause(20)
})
input.onButtonPressed(Button.B, function () {
    serial.writeLine("EVENT:B")
    basic.pause(20)
})
