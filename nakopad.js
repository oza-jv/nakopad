...
const SAMPLE_LIST = [
	...
	{ value: '', name: '--' },
	{ value: './sample/sample-media-1pic.txt',   name: 'メディア1 画像を使う命令の例' },
	{ value: './sample/sample-media-2audio.txt',   name: 'メディア2 音を使う命令の例' },
	{ value: './sample/sample-media-3movie.txt',   name: 'メディア3 動画を使う命令の例' },
	{ value: './sample/sample-media-4chart1.txt',   name: 'メディア4 線グラフをかく例' },
	{ value: '', name: '--' },
	...
	{ value: './sample/wschat-4-img_send.txt',       name: '通信2 画像を送受信する簡易チャットの例' },
	{ value: '', name: '--' },
	...
	{ value: './sample/mb05-ifthen.txt',     name: '計測・制御_M2 もし～ならば～違えば' },
	{ value: './sample/mb06-ifthenelse.txt', name: '計測・制御_M3 もし～ならば～違えばもし' },
	{ value: './sample/mb08-carsensor-def.txt',      name: '計測・制御_M8 衝突防止ｱﾗｰﾑを作る' },
	{ value: './sample/mb09-carsensor.txt',          name: '計測・制御_M9 衝突防止ｱﾗｰﾑの応用例' },
	{ value: './sample/mb10-carsensor-media.txt',    name: '計測・制御_M10 衝突防止ｱﾗｰﾑ ﾒﾃﾞｨｱ利用例' },
	{ value: '', name: '--' },
